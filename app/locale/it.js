module.exports = {
  ...
  translation: {
    ...
    choose_hero: {
      ...
      java_blurb: '(Solo per gli abbonati) Android e imprese',
      cpp_blurb: '(Solo per gli abbonati) Sviluppo di giochi e calcolo ad alte prestazioni',
      code_format: 'Formato del codice',
      text_code: 'Codice di testo,
      blocks_and_code: 'Blocchi e codice',
      blocks_text: 'Blocchi',
      blocks_icons: 'Blocchi (icone)',
      text_code_blurb: 'Digita codice basato sul testo in un vero editor di codice',
      blocks_and_code_blurb: 'Blocchi e testo codice fianco a fianco',
      blocks_text_blurb: 'Blocchi da Drag e drop per i tablet o per gli studenti più giovani',
      blocks_icons_blurb: 'Blocchi basati su icone per telefoni o prelettori',
      status: 'Stato',
      weapons: 'Armi',
      ...
      attack_1: 'Infligge',
      attack_2: 'dei danni',
      attack_3: 'dell\'armatura elencata.',
      health_1: 'Guadagni',
      health_2: 'di salute',
      health_3: 'dell\'armatura.',
      speed_1: 'Si muove a',
    ...
    char_customization_modal: {
      heading: 'Personalizza il tuo Eroe',
      body: 'Corpo',
      name_label: 'Nome dell\'eroe',
      hair_label: 'Colore Capelli',
      skin_label: 'Colore Pelle',
    },
